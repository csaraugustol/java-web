                ...
                <div class="card-body bg-primary text-center text-light font-weight-bold">
                    <form method="POST" action="nomes">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control text-center" name="cpNome" id="cpNome" type="text" placeholder="Seu nome e sobrenome" required> 
                        </div>

                        <div class="form-group mt-5">
                            <input class="btn btn-success btn-outline-danger text-center text-light col-md-8" type="submit" value="Cadastrar" name="btnCadastrar" id="btnCadastrar" style="cursor: pointer">
                        </div>
