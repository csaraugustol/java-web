...
import br.vianna.atividade.appvotacao.model.Aluno;
 ...
 * @author cesar
 */
@WebServlet(name = "ServletVotacao", urlPatterns = {"/nomes"})
public class ServletVotacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Aluno a = new Aluno(request.getParameter("cpNome"));
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("nomes.jsp");
